...
namespace Core.Flight
{
    ...
    public class FlightBookingResponse
    {
        ...
        [DataMember]
        public string TvoInvoiceNo { get; set; }
        [DataMember]
        ...
        [DataMember]
        public int ST_Request_id { get; set; }

        [DataMember]
        public string ST_tx_id { get; set; }

        [DataMember]
        public string AirIQ_Booking_id { get; set; }

        [DataMember]
        public string AirIQ_AirlineCode { get; set; }
        [DataMember]
        public string AirIQ_Msg { get; set; }
