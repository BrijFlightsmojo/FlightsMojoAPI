...
{
    public class TravelogyResponseMapping
    {
        ...
        public void getResults(Core.Flight.FlightSearchRequest request, ref TravelogyClass.TravelogyFlightSearchResponse fsr, ref Core.Flight.FlightSearchResponseShort response)
        {
            int ctrError = 0;
            try
            {
